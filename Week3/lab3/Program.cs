...
namespace FarManager3
{
    ...
    class Program
    {
        ...
        {
            DirectoryInfo dir = new DirectoryInfo(@"C:\Users\Twins\Desktop\Nurbolat");  // наша главная директория 
                ...
                switch (consoleKeyInfo.Key)  // создаем условный оператор  
                {
                    ...
                    case ConsoleKey.Delete: // клавиша удаления 
                        ...
                        if (fileSystemInfo2.GetType() == typeof(DirectoryInfo)) // если директория  
                        {
                            ...
                            history.Peek().Content = directoryInfo.Parent.GetFileSystemInfos(); // кидаем в стэк только его парентс                                                                                                  // так как файла уже нет 
                        }
                        else // если файл 
                        {
